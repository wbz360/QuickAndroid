...
import com.appdsn.qa.ui.xrecyclerview.CommonRecyclerAdapter;
import com.appdsn.qa.ui.xrecyclerview.LoadMoreRecyclerView;
import com.appdsn.qa.ui.xrecyclerview.LoadMoreRecyclerView.OnLoadListener;
import com.appdsn.qa.ui.xrecyclerview.XRecyclerAdapter.OnItemClickLitener;
	...
	protected void loadData() {
		...
		filmListAdapter = new CommonRecyclerAdapter<String>(mContext,
			...
			public void convert(BaseViewHolder holder, String itemData,
					int realPosition) {
				// TODO Auto-generated method stub
				ImageView imageView = (ImageView) holder.getView(R.id.imgFilmCover);
				ImageLoader.getInstance().displayImage("http://weixin-10007714.image.myqcloud.com/weixin56a84a6144c3e1453869665", imageView);
			}
			...
			@Override
			public com.appdsn.qa.ui.xrecyclerview.XRecyclerAdapter.BaseViewHolder onCreateHolder(
					ViewGroup parent, int itemType) {
				// TODO Auto-generated method stub
				BaseViewHolder holder=null;
				if (itemType==0) {
					holder=new BaseViewHolder(mInflater.inflate(R.layout.list_item_show_film_list, parent, false));
				}else if (itemType==1) {
					holder=new BaseViewHolder(mInflater.inflate(R.layout.layout_main_banner_item, parent, false));
				}
